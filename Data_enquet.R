...
Enquête_dopinion_relative_à_la_journée_dintégration_ <- read_excel("C:/Users/lenovo/Desktop/Semestre_6/Exposé/Traitement-de-questions-ouvertes-avec-R-Text-mining/Enquête_dopinion_relative_à_la_journée_dintégration).xlsx")
